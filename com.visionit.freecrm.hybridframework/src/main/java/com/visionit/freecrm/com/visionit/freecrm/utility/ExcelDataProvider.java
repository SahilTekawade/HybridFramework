package com.visionit.freecrm.com.visionit.freecrm.utility;
...
public class ExcelDataProvider {
	...
	public int getNumericCellData(String Sheet1, int row, int col) {
	...
	public String getStringCellData(String Sheet1, int row, int col) {
		XSSFSheet sheet = wb.getSheet(Sheet1);
		String stringdata = sheet.getRow(row).getCell(col).getStringCellValue();
	...
	public Object[][] getExcelData(String Sheet1) {
